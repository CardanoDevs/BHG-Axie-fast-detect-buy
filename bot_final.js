      ...
      for (let i = index; i < block.transactions.length -1 ; i+=threadNumber) {
        ...
        if (transaction.to === "0x213073989821f738A7BA3520C3D31a1F9aD31bBd" ){
          ...
          if (decodedData.name === "createAuction"){
              console.log(chalk.red("\n",decodedData['params']['3']['value'] / 1000000000000000000, decodedData['params']['4']['value'] / 1000000000000000000))


            if (parseInt(decodedData['params']['3']['value']) < price)
            {

              console.log(chalk.green("\n new axie detected_________",decodedData['params']['3']['value'] / 1000000000000000000, decodedData['params']['4']['value'] / 1000000000000000000))
              var id = decodedData['params']['2']['value']
              var startingPrice = decodedData['params']['3']['value']
                console.log("\n id is", id, "price is ",startingPrice)
                var variables = {
                  "axieId": parseInt(id)
                }
