            ...
            while (flag){
              ...
              if(data.axie.battleInfo.banned == true){
                ...
                if(data.axie.auction !== null){
                  ...
                  else if (parseInt(data.axie.auction.suggestedPrice)<price && data.axie.battleInfo.banned == false) {
                    // send transaction for buy a
                    console.log(chalk.green(" Request result : axie's price is ", data.axie.auction.suggestedPrice / 1000000000000000000))
